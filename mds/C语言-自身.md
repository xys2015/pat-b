...
http://zh.cppreference.com/w/c/types/limits

## 外部变量

定义在所有函数之外的变量称为外部变量, 其值对该文件的所有函数都可用,  
其作用域就是该文件. 外部变量使用的不是栈内存, 其可以使用的内存, 可以  
非常大.  

外部变量可用被显示初始化, 如果未显示初始化则自动初始化为0
